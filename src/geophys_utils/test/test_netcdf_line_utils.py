...
TEST_GET_LINE_MASK_RESULTS = ((190520, 5032), (190500, 4994))

TEST_GET_LINE_RESULTS = ((190520, 7, 10064), (190500, 7, 9988))
...
class TestNetCDFLineUtilsFunctions1(unittest.TestCase):
    ...
    def test_get_line_masks(self):
        ...
        for line_number, line_mask in netcdf_line_utils.get_line_masks():
            ...
            ) == TEST_GET_LINE_MASK_RESULTS[count], "Invalid get_line_masks result"
            count += 1
            if count >= 2:
                break
    ...
    def test_get_lines(self):
        ...
        for line_number, line_dict in netcdf_line_utils.get_lines():
            ...
            assert (
                ...
                len(line_dict) - 1,
                np.count_nonzero(line_dict["coordinates"]),
            ) == TEST_GET_LINE_RESULTS[
                count
            ], "Invalid get_lines result: Expected {}, got {}".format(
...
def test_suite():
    ...
    test_classes = [
        TestNetCDFLineUtilsConstructor,
