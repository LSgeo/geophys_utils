...
class DataStats(object):
    ...
    def __init__(self, netcdf_path=None, netcdf_dataset=None, max_bytes=500000000):
        ...
        """
        assert (
            netcdf_dataset or netcdf_path
        ), "Either netcdf_dataset or netcdf_path must be defined"
        assert not (
            netcdf_dataset and netcdf_path
        ), "netcdf_dataset and netcdf_path cannot both be defined"
