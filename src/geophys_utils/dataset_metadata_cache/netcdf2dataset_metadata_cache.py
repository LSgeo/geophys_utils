...
# FILE_PATH_MAPS = None
FILE_PATH_MAPS = {
    "D:\\Temp\\gravity point_datasets\\": "/g/data2/uc0/rr2_dev/axi547/ground_gravity/point_datasets/",
...
OPENDAP_PATH_MAPS = {
    "/g/data2/uc0/rr2_dev/": "http://dapds00.nci.org.au/thredds/dodsC/uc0/rr2_dev/",
...
def main():
    ...
    ), "Usage: {} <root_dir> [<file_template>]".format(sys.argv[0])
