...
class Grav2NetCDFConverter(ToNetCDFConverter):
    ...
    def get_global_attributes(self):
        ...
        metadata_dict = {
            ...
            " geophysics, geoscientificInformation".format(
                self.survey_id,
            ...
            "gravity based on the underlying structure or geology".format(
                self.survey_id,
            ...
            "time_coverage_duration": (
                str(
                    self.survey_metadata.get("ENDDATE")
                    - self.survey_metadata.get("STARTDATE")
                )
                if self.survey_metadata.get("STARTDATE")
                else "Unknown"
            ),
    ...
    def variable_generator(self):
        ...
        yield NetCDFVariable(
            short_name="ga_gravity_metadata",
            data=0,
            dimensions=[],  # Scalar
            fill_value=None,
    ...
    for survey in survey_id_list:
        ...
        if survey == "201460":
            ...
            g2n = Grav2NetCDFConverter(
                "{0}/P{1}_GNDGRAV.nc".format(nc_out_path, str(survey)),
                survey,
                con,
                sql_strings_dict,
            )
